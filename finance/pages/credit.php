<?php
    ...
    //echo addslashes($msg);
    require('../../handler/creditslip.php');
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="page-header"><i class="fa fa-edit"> Credit Slip</i></h1>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading bg-success">
                            Revenue Generation | fields marked * are compulsory
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input list="income" class="form-control" placeholder="provide income source" name="income" required>
                                            <datalist id="income">
                                                <option value="Free-will Donations">
                                                <option value="Group Competition">
                                                <option value="Thanksgiving">
                                                <option value="Bank Alerts">
                                        ...
                                        <div class="form-group">
                                            <label>Amount *</label>
                                            <input class="form-control" type="number" placeholder="enter amount" name="amount" required min="0">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="submit" name="credit" class="btn btn-success">
                                    </form>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
