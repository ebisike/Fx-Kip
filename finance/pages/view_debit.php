...
<head>
    ...
    <title>Debit Account Book</title>
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="page-header"><i class="fa fa-book"> Debit Account Book</i></h1>
            ...
            <div class="row">
                <div class="panel-body">
                            <div class="table-responsive">
                                <div class="row">
                                    <div class="col-lg-12"><?php $account->getRecords(4);?></div>
                                    <div class="col-lg-12">
                                        <?php
                                            $data=$account->getBalance();
                                            $data['balance'] +=0;
                                            echo '<p>Available Balance: <span>&#8358</span>'.$data['balance'].'.00</p>';
                                        ?>
                                    </div>
                                </div>
